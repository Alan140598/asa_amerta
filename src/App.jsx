...
import CardUkm from "./component/CardUkm";
    ...
    <div>
      ...
      <div className="lg:h-[600px] flex items-center bg-blue-100">
        ...
        >
          ...
          <Link to="page/ukmPage" className="border-2 border-blue-500 lg:px-4 lg:py-1 lg:rounded-lg cursor-pointer flex justify-center items-center gap-1">
      ...
      <div className="lg:h-[600px] flex items-center">
        ...
        >
          ...
          <a className="border-2 border-blue-500 lg:px-4 lg:py-1 lg:rounded-lg cursor-pointer flex justify-center items-center gap-1">
            Lihat  <GrFormNextLink className="text-xl"/>
          </a>
        </div>
